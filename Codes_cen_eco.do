...
//New Variable Creation and Data Processing
...
reg lngnexp_usd cen
 ...
 ed if country=="Bangladesh" [For one country]
...
//Centralization and Investment Variables
...
twoway (scatter lnnewgnexp_usd cen)
 ...
 xtreg cen cdum1-cdum30 time
   ...
   xtreg cen lnnewgnexp_usd cdum1-cdum30
    predict cenhat [2SLS Method]
	 xtreg lnnewgcapf_usd cenhat lnnew_gsav_usd
    xtreg lnnewgcapf_usd cenhat lnnew_gsav_usd, fe 
	xtreg lngcapf_usd cen lngsav_usd lngnexp_usd, fe 
	xtreg lngcapf_usd cen, fe
	
//Centralization and Inequality Variable
...
twoway (scatter  new_gini new_livbelow_50perc_midinc )
 xtreg new_gini cenhat new_inc_share_top10 new_livbelow_50perc_midinc, fe 
